...
const useCases = [
  {
    ...
    features: [
      "Revenue vs ad spend dashboard",
      "Shopify revenue synced in real-time",
      "ROAS tracking by channel & campaign",
      "Founder Mode: simple 3-metric view",
    ],
  },
  {
    title: "E-commerce Agencies",
    description: "Manage all your clients from one dashboard. Multi-account access, role-based permissions, and unified reporting.",
    features: [
  ...
  {
    title: "Growth Teams",
    description: "Stop waiting for weekly data pulls. Get real-time visibility into campaign performance with cohort and funnel analytics.",
    features: [
      "Real-time performance dashboards",
      "Cohort analysis & retention heatmaps",
      "Funnel visualization",
      "Creative Intelligence with fatigue alerts",
    ],
  },
];
