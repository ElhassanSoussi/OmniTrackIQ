...
export default function KPICard({ label, value, subtext, trend, tone = "neutral" }: KPICardProps) {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-gray-900 transition-colors duration-200">
      ...
      {subtext && <div className="mt-1 text-sm text-gray-500 dark:text-gray-400">{subtext}</div>}
    </div>
  );
}
