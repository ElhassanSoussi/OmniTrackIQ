...
""",
    ...
    openapi_tags=[
        ...
        },
        {
            ...
            "description": "Channel contribution analysis and budget optimization",
        },
        {
            "name": "Incrementality",
            "description": "Measure true incremental impact of marketing spend",
        },
        {
            "name": "Custom Reports",
        ...
        {
            "name": "Events",
            "description": "Product analytics event tracking for understanding user behavior",
        },
    ],
    docs_url="/docs",
    redoc_url="/redoc",
...
app.include_router(routes_insights.router, prefix="/analytics")
